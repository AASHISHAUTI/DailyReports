...
{
    $connect = mysqli_connect("127.0.0.1", "root", "root", "assignmentiit");
...
echo '<title>New Session Details</title>';
		...
		echo '<a href="index.php"><h2 align = "center">Add User</h2></a>';
		...
		echo ' <!-- populate table from mysql database -->';
          ...
          ?>      
			...
			<form action= "StartSession.php" method = "post">
				...
				<td><input type="textbox" name = "message" value="<?php echo $row['message']; ?>" /></td>
